function [qlike,Fe,tres,uhat] = cal_quasi_like_aDFM_Utilde(param,UN,Y,r,n,Pbullet)
% calculates the quasi likelihood for aDFM system for fixed Lambda matrix. 
%
% SYNTAX: [qlike,Fhat,Fres] = cal_quasi_like_aDFM_Utilde(param,Utilde,Y,r,n,Pbull)
%
...
[th,RN] = param_syst_aDFM_Utilde(param,r,n);
Lambda = [eye(r);UN*RN];
[Q,R]=qr(Lambda);
Utilde = Q(:,1:r); 
