function  [results,the,thi,qlike,Lambdai] = est_aDFM_Utilde(Y,r,n,UN,Pbull,thi)
...
[pare,fval,exitflag] = fminunc(@(x) cal_quasi_like_aDFM_Utilde(x,UN,Y,r,n,Pbull),parami,options);

[qlike,Fhat,tres,uhat] = cal_quasi_like_aDFM_Utilde(pare,UN,Y,r,n,Pbull);

[the,RNe] = param_syst_aDFM_Utilde(pare,r,n);
