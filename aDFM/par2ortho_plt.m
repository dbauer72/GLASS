function [C,QL] = par2ortho_plt(par,n,p);
% par2ortho_plt transforms the parameters in par into the orthonormal column C (plt).
% Inverse to ortho2par_plt. 
%
...
%         s,c ... dimensions of C. 
%      
% OUTPUT: C ... sxc matrix, C'C=I_c and plt. 
%
