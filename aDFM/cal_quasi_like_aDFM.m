function [qlike,Fhat,tres,uhat] = cal_quasi_like_aDFM(param,Y,r,q,n,Pbullet)
% calculates the quasi likelihood for aDFM system
%
% SYNTAX: [qlike,Fhat,Fres] = cal_quasi_like_aDFM(x,Y,r,q,n,Pbull)
%
% INPUTS:  param ... d x 1 vector of parameter values (fed into param_syst_aDFM,
...
[th,Lam,Gam_zeta] = param_syst_aDFM(param,N,r,q,n);
