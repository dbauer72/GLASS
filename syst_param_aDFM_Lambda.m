function param = syst_param_aDFM_Lambda(th)
% syst_param_aDFM_Lambda converts a normalized system into a parameter vector.
%
% SYNTAX:  param = syst_param_aDFM_Lambda(th)
%
